...
function hambarboxHeight() {
  ...
  document.documentElement.style.setProperty('--scroll-padding', navHeight - 3 + 'px');
}
hambarboxHeight();
...
gsap.from(".projectsContainer .projectCard:nth-child(1)", {
  y:10,
  opacity:0,
  scrollTrigger:{
    trigger:".projectsContainer .projectCard:nth-child(1)",
    // markers:true,
    start:"top 100%"
  }
});
gsap.from(".projectsContainer .projectCard:nth-child(2)", {
  y:10,
  opacity:0,
  scrollTrigger:{
    trigger:".projectsContainer .projectCard:nth-child(2)",
    // markers:true,
    start:"top 100%"
  }
});
gsap.from(".projectsContainer .projectCard:nth-child(3)", {
  y:10,
  opacity:0,
  scrollTrigger:{
    trigger:".projectsContainer .projectCard:nth-child(3)",
    // markers:true,
    start:"top 100%"
  }
});

var projectCard = document.querySelectorAll(".projectCard");
